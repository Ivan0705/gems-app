import { i as H } from "./i18next-cOPaZ5Oq.js";
import { c as k, g as ve } from "./_commonjsHelpers-Cpj98o6Y.js";
import { s as we, b as Oe } from "./i18nInstance-DCxlOlkw.js";
function Se(n, e) {
...
const Pe = {
    type: "3rdParty",
    init(n) {
      we(n.options.react), Oe(n);
    },
  },
  { slice: Ae, forEach: Ee } = [];
function _e(n) {
  return (
    Ee.call(Ae.call(arguments, 1), (e) => {
      if (e) for (const r in e) n[r] === void 0 && (n[r] = e[r]);
    }),
    n
  );
}
const G = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
  Te = (n, e, r) => {
    ...
    if (t.domain) {
      if (!G.test(t.domain)) throw new TypeError("option domain is invalid");
      a += `; Domain=${t.domain}`;
    }
    if (t.path) {
      if (!G.test(t.path)) throw new TypeError("option path is invalid");
      a += `; Path=${t.path}`;
    }
    if (t.expires) {
  ...
  V = {
    create(n, e, r, t) {
      ...
      r &&
        ...
        t && (i.domain = t),
        (document.cookie = Te(n, encodeURIComponent(e), i));
    },
    read(n) {
      const e = `${n}=`,
...
var je = {
    name: "cookie",
    lookup(n) {
      let { lookupCookie: e } = n;
      if (e && typeof document < "u") return V.read(e) || void 0;
    },
    cacheUserLanguage(n, e) {
      ...
      r && typeof document < "u" && V.create(r, n, t, i, a);
    },
  },
  xe = {
    name: "querystring",
    lookup(n) {
      var t;
      let { lookupQuerystring: e } = n,
        r;
      if (typeof window < "u") {
        let { search: i } = window.location;
        !window.location.search &&
          ((t = window.location.hash) == null ? void 0 : t.indexOf("?")) > -1 &&
          (i = window.location.hash.substring(
            window.location.hash.indexOf("?"),
          ));
        const f = i.substring(1).split("&");
        for (let u = 0; u < f.length; u++) {
          const c = f[u].indexOf("=");
          c > 0 && f[u].substring(0, c) === e && (r = f[u].substring(c + 1));
        }
      }
      return r;
    },
...
var De = {
  name: "localStorage",
  lookup(n) {
    let { lookupLocalStorage: e } = n;
    if (e && K()) return window.localStorage.getItem(e) || void 0;
  },
  cacheUserLanguage(n, e) {
    let { lookupLocalStorage: r } = e;
    r && K() && window.localStorage.setItem(r, n);
  },
};
let D = null;
const Q = () => {
  if (D !== null) return D;
  try {
    D = window !== "undefined" && window.sessionStorage !== null;
    const n = "i18next.translate.boo";
...
var ke = {
    name: "sessionStorage",
    lookup(n) {
      let { lookupSessionStorage: e } = n;
      if (e && Q()) return window.sessionStorage.getItem(e) || void 0;
    },
    cacheUserLanguage(n, e) {
      let { lookupSessionStorage: r } = e;
      r && Q() && window.sessionStorage.setItem(r, n);
    },
  },
  qe = {
    name: "navigator",
    lookup(n) {
      ...
      if (typeof navigator < "u") {
        const { languages: r, userLanguage: t, language: i } = navigator;
        if (r) for (let a = 0; a < r.length; a++) e.push(r[a]);
        t && e.push(t), i && e.push(i);
      }
  ...
  Le = {
    ...
    lookup(n) {
      var i, a;
      let { lookupFromSubdomainIndex: e } = n;
      const r = typeof e == "number" ? e + 1 : 1,
        t =
          typeof window < "u" &&
          ((a = (i = window.location) == null ? void 0 : i.hostname) == null
            ? void 0
            : a.match(
...
class ne {
  ...
  init(e) {
    ...
    (this.services = e || { languageUtils: {} }),
      (this.options = _e(r, this.options || {}, Ue())),
  ...
  detect(e) {
    ...
    return (
      e.forEach((t) => {
        if (this.detectors[t]) {
          let i = this.detectors[t].lookup(this.options);
          i && typeof i == "string" && (i = [i]), i && (r = r.concat(i));
        }
      }),
      (r = r.map((t) => this.options.convertDetectedLanguage(t))),
...
function Ie(n) {
  return Ce(n) ? n : Promise.resolve(n);
}
function He(n) {
  throw new Error(
      ...
      (function (n, e) {
        ...
        (function (a) {
          (function (f) {
            ...
            if (c.arrayBuffer)
              var p = [
                ...
                y =
                  ...
                  function (o) {
                    return (
                      o && p.indexOf(Object.prototype.toString.call(o)) > -1
                    );
                  };
            function v(o) {
              if (
            ...
            (h.prototype.append = function (o, s) {
              (o = v(o)), (s = w(s));
              var l = this.map[o];
              this.map[o] = l ? l + ", " + s : s;
            }),
              ...
              (h.prototype.get = function (o) {
                return (o = v(o)), this.has(o) ? this.map[o] : null;
              }),
              (h.prototype.has = function (o) {
                return this.map.hasOwnProperty(v(o));
              }),
              (h.prototype.set = function (o, s) {
                this.map[v(o)] = w(s);
              }),
              (h.prototype.forEach = function (o, s) {
                for (var l in this.map)
                  this.map.hasOwnProperty(l) && o.call(s, this.map[l], l, this);
              }),
            ...
            function ce(o) {
              var s = new FileReader(),
                l = $(s);
              return s.readAsArrayBuffer(o), l;
            }
            function le(o) {
              var s = new FileReader(),
                l = $(s);
              return s.readAsText(o), l;
            }
            function de(o) {
              for (
                var s = new Uint8Array(o), l = new Array(s.length), g = 0;
                g < s.length;
                g++
              )
                l[g] = String.fromCharCode(s[g]);
              return l.join("");
            }
            function N(o) {
                ...
                (this._initBody = function (o) {
                  (this.bodyUsed = this.bodyUsed),
                    ...
                    o
                      ? typeof o == "string"
                        ? (this._bodyText = o)
                        : c.blob && Blob.prototype.isPrototypeOf(o)
                          ? (this._bodyBlob = o)
                          : c.formData && FormData.prototype.isPrototypeOf(o)
                            ? (this._bodyFormData = o)
                            : c.searchParams &&
                                URLSearchParams.prototype.isPrototypeOf(o)
                              ? (this._bodyText = o.toString())
                              : c.arrayBuffer && c.blob && b(o)
                                ? ((this._bodyArrayBuffer = N(o.buffer)),
            ...
            function E(o, s) {
              ...
              if (o instanceof E) {
                ...
                (this.url = o.url),
                  ...
                  s.headers || (this.headers = new h(o.headers)),
                  (this.method = o.method),
                  (this.mode = o.mode),
                  (this.signal = o.signal),
                  !l &&
                    o._bodyInit != null &&
                    ((l = o._bodyInit), (o.bodyUsed = !0));
              } else this.url = String(o);
              if (
                ((this.credentials =
                  s.credentials || this.credentials || "same-origin"),
                (s.headers || !this.headers) &&
                  (this.headers = new h(s.headers)),
                (this.method = pe(s.method || this.method || "GET")),
              ...
              if (
                ...
                var g = /([?&])_=[^&]*/;
                if (g.test(this.url))
                  this.url = this.url.replace(g, "$1_=" + new Date().getTime());
                else {
                  var m = /\?/;
                  this.url +=
                    (m.test(this.url) ? "&" : "?") +
                  ...
                  .forEach(function (l) {
                    if (l) {
                      var g = l.split("="),
                        m = g.shift().replace(/\+/g, " "),
                        d = g.join("=").replace(/\+/g, " ");
                      s.append(decodeURIComponent(m), decodeURIComponent(d));
                    }
                  }),
                s
              );
...
`) === 0
            ...
            function S(o, s) {
              ...
              s || (s = {}),
                ...
                (this.statusText =
                  s.statusText === void 0 ? "" : "" + s.statusText),
                (this.headers = new h(s.headers)),
                (this.url = s.url || ""),
                this._initBody(o);
            }
            ...
            (S.redirect = function (o, s) {
              if (me.indexOf(s) === -1)
                throw new RangeError("Invalid status code");
              return new S(null, { status: s, headers: { location: o } });
            }),
              (f.DOMException = u.DOMException);
            try {
              new f.DOMException();
            } catch {
              (f.DOMException = function (s, l) {
            ...
            function C(o, s) {
              return new Promise(function (l, g) {
                ...
                if (m.signal && m.signal.aborted)
                  return g(new f.DOMException("Aborted", "AbortError"));
                ...
                (d.onload = function () {
                  ...
                  (d.onabort = function () {
                    setTimeout(function () {
                      g(new f.DOMException("Aborted", "AbortError"));
                    }, 0);
                  });
                function be(O) {
                  try {
                ...
                d.open(m.method, be(m.url), !0),
                  ...
                  s && typeof s.headers == "object" && !(s.headers instanceof h)
                    ? Object.getOwnPropertyNames(s.headers).forEach(
                        function (O) {
                          d.setRequestHeader(O, w(s.headers[O]));
                        },
                      )
                    : m.headers.forEach(function (O, B) {
                        d.setRequestHeader(B, O);
                      }),
                  m.signal &&
...
(function (n, e) {
  var r = typeof fetch == "function" ? fetch : void 0;
  if (
    (typeof k < "u" && k.fetch
      ? (r = k.fetch)
      : typeof window < "u" && window.fetch && (r = window.fetch),
    typeof He < "u" && typeof window > "u")
  ) {
    var t = r || Fe();
    t.default && (t = t.default), (e.default = t), (n.exports = e.default);
  }
})(M, M.exports);
var ie = M.exports;
const se = ve(ie),
  J = Se({ __proto__: null, default: se }, [ie]);
function Z(n, e) {
  var r = Object.keys(n);
...
var _ = typeof fetch == "function" ? fetch : void 0;
typeof global < "u" && global.fetch
  ? (_ = global.fetch)
  : typeof window < "u" && window.fetch && (_ = window.fetch);
var q;
oe() &&
  (typeof global < "u" && global.XMLHttpRequest
    ? (q = global.XMLHttpRequest)
    : typeof window < "u" &&
...
var X = function (e, r) {
    if (r && T(r) === "object") {
      var t = "";
      for (var i in r)
        t += "&" + encodeURIComponent(i) + "=" + encodeURIComponent(r[i]);
      if (!t) return e;
  ...
  ee = function (e, r, t, i) {
    var a = function (c) {
      if (!c.ok) return t(c.statusText || "Error", { status: c.status });
      c.text()
        .then(function (b) {
          t(null, { status: c.status, data: b });
        })
        .catch(t);
    };
    if (i) {
    ...
    typeof fetch == "function"
      ? fetch(e, r).then(a).catch(t)
      : _(e, r).then(a).catch(t);
  },
  te = !1,
  Ne = function (e, r, t, i) {
    e.queryStringParams && (r = X(r, e.queryStringParams));
    var a = Y(
      {},
    ...
    try {
      ...
      if (
        ...
        !b.message ||
        b.message.indexOf("not implemented") < 0
      )
        return i(b);
      try {
  ...
  ze = function (e, r, t, i) {
    t && T(t) === "object" && (t = X("", t).slice(1)),
      e.queryStringParams && (r = X(r, e.queryStringParams));
    try {
      var a;
      q ? (a = new q()) : (a = new U("MSXML2.XMLHTTP.3.0")),
        a.open(t ? "POST" : "GET", r, 1),
        e.crossDomain ||
      ...
      (a.onreadystatechange = function () {
        a.readyState > 3 &&
          i(a.status >= 400 ? a.statusText : null, {
            status: a.status,
            data: a.responseText,
          });
      }),
  ...
  Ge = function (e, r, t, i) {
    if (
      ...
      return Ne(e, r, t, i);
    if (oe() || typeof ActiveXObject == "function") return ze(e, r, t, i);
...
function Ke(n, e) {
  for (var r = 0; r < e.length; r++) {
    ...
    (t.enumerable = t.enumerable || !1),
      ...
      Object.defineProperty(n, fe(t.key), t);
  }
}
function Qe(n, e, r) {
  return (
...
var Je = function () {
    return {
      ...
      parsePayload: function (r, t, i) {
        return ae({}, t, i || "");
      },
      parseLoadPayload: function (r, t) {},
      request: Ge,
    ...
    return Qe(n, [
      {
        ...
        value: function (r) {
          ...
          if (
            ((this.services = r),
            (this.options = I(I(I({}, Je()), this.options || {}), i)),
            (this.allOptions = a),
            ...
            j(f) === "object" && typeof f.unref == "function" && f.unref();
          }
        },
      },
      {
      ...
      {
        key: "_readAny",
        value: function (r, t, i, a, f) {
          var u = this,
            c = this.options.loadPath;
          typeof this.options.loadPath == "function" &&
            (c = this.options.loadPath(r, i)),
            (c = Ie(c)),
            c.then(function (b) {
              if (!b) return f(null, {});
              var p = u.services.interpolator.interpolate(b, {
                lng: r.join("+"),
                ns: i.join("+"),
              });
              u.loadUrl(p, f, t, a);
      ...
      },
      {
        ...
        value: function (r, t, i, a) {
          var f = this,
            ...
            b = this.options.parseLoadPayload(u, c);
          this.options.request(this.options, r, b, function (p, y) {
            if (y && ((y.status >= 500 && y.status < 600) || !y.status))
              return t(
                "failed loading " + r + "; status code: " + y.status,
                !0,
              );
            if (y && y.status >= 400 && y.status < 500)
              return t(
                "failed loading " + r + "; status code: " + y.status,
                !1,
              );
            if (!y && p && p.message) {
              var v = p.message.toLowerCase(),
                w = ["failed", "fetch", "network", "load"].find(function (A) {
                  return v.indexOf(A) > -1;
                });
              if (w) return t("failed loading " + r + ": " + p.message, !0);
            }
            if (p) return t(p, !1);
            var P, h;
            try {
              typeof y.data == "string"
                ? (P = f.options.parse(y.data, i, a))
                : (P = y.data);
            } catch {
      ...
      },
      {
        ...
        value: function (r, t, i, a, f) {
          ...
          if (this.options.addPath) {
            typeof r == "string" && (r = [r]);
            var c = this.options.parsePayload(t, i, a),
              b = 0,
              p = [],
              y = [];
            r.forEach(function (v) {
              var w = u.options.addPath;
              typeof u.options.addPath == "function" &&
                (w = u.options.addPath(v, t));
              var P = u.services.interpolator.interpolate(w, { lng: v, ns: t });
              u.options.request(u.options, P, c, function (h, A) {
                (b += 1),
                  p.push(h),
                  y.push(A),
                  b === r.length && typeof f == "function" && f(p, y);
              });
            });
          }
        },
          ...
          if (!(u && u.toLowerCase() === "cimode")) {
            ...
            b(u),
              ...
              c.forEach(function (p) {
                r.allOptions.ns.forEach(function (y) {
                  i.read(p, y, "read", null, null, function (v, w) {
                    v &&
                      f.warn(
                        "loading namespace "
                          .concat(y, " for language ")
                          .concat(p, " failed"),
                        v,
                      ),
                      !v &&
                      ...
                      i.loaded("".concat(p, "|").concat(y), v, w);
                  });
                });
              });
          }
...
const Ze = H.on("languageChanged", (n) => {
    const e = H.dir(n);
    document.dir = e;
  }),
  rt = {

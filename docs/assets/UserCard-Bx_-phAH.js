...
import { r as x } from "./index-ClcD9ViR.js";
import { A as q } from "./Avatar-DgzAITNe.js";
import { B as y, a as S } from "./Button-CEQMFML8.js";
import { u as A } from "./useTranslation-qApjsL5e.js";
const b = "_userCard_oha28_1",
  h = "_userCard_avatar_oha28_20",
  j = "_userCard_userInfo_oha28_24",
  g = "_userCard_companyInfo_oha28_27",
  C = "_user_oha28_1",
  f = "_name_oha28_41",
  B = "_btn_oha28_46",
  s = {
              ...
              children: [
                e.jsx("div", {
                  ...
                  children: e.jsx("figure", {
                    className: s.userCard_avatar,
                    children: e.jsx(q, { size: 280, src: K }),
                  }),
                }),
                e.jsxs("div", {
                  className: s.userCard_userInfo,
                  children: [
                    e.jsxs("div", {
                      className: s.name,
                      children: [r("name"), ":", i],
                    }),
                    e.jsxs("div", { children: [r("username"), ":", o] }),
                    e.jsxs("div", { children: [r("email"), ":", c] }),
                    e.jsxs("address", {
                      children: [r("street"), ":", a.street],
                    }),
                    e.jsxs("address", { children: [r("city"), ":", a.city] }),
                    e.jsxs("address", { children: [r("suite"), ":", a.suite] }),
                    e.jsxs("address", {
                      children: [r("zipcode"), ":", a.zipcode],
                    }),
                    e.jsxs("address", {
                      children: [r("geo_lat"), ":", a.geo.lat],
                    }),
                    e.jsxs("address", {
                      children: [r("geo_lng"), ":", a.geo.lng],
                    }),
                    e.jsxs("div", { children: [r("phone"), ":", m] }),
                    e.jsxs("div", { children: [r("website"), ":", u] }),
                  ],
                }),
              ],
            }),
            e.jsxs("div", {
              className: s.userCard_companyInfo,
              children: [
                e.jsxs("div", { children: [r("company"), ": "] }),
                e.jsxs("div", { children: [r("company_name"), ":", n.name] }),
                e.jsxs("div", {
                  children: [r("company_catchPhrase"), ":", n.catchPhrase],
                }),
                e.jsxs("div", { children: [r("company_bs"), ":", n.bs] }),
              ],
            }),
          ],
        },
...
I.__docgenInfo = {
  ...
  props: {
    id: { required: !0, tsType: { name: "number" }, description: "" },
    name: { required: !0, tsType: { name: "string" }, description: "" },
    username: { required: !0, tsType: { name: "string" }, description: "" },
    email: { required: !0, tsType: { name: "string" }, description: "" },
    address: { required: !0, tsType: { name: "IAddress" }, description: "" },
    phone: { required: !0, tsType: { name: "string" }, description: "" },
    website: { required: !0, tsType: { name: "string" }, description: "" },
    company: { required: !0, tsType: { name: "ICompany" }, description: "" },
    goToBack: {
      required: !0,
      tsType: {
        name: "signature",
        ...
        signature: {
          ...
          return: {
            name: "union",
            raw: "void | any",
            elements: [{ name: "void" }, { name: "any" }],
          },
        },
      },
      description: "",
    },
    btn_title: { required: !0, tsType: { name: "string" }, description: "" },

import { c as bn } from "./_commonjsHelpers-Cpj98o6Y.js";
var ge = { exports: {} };
(function (n, a) {
  (function (o, i) {
    i(a);
      ...
      case "union":
        return (p = n.elements) != null && p.every(vn)
          ? {
              ...i,
              name: "enum",
              value: (u = n.elements) == null ? void 0 : u.map(Sn),
            }
          : {
              ...i,
              name: a,
              value: (y = n.elements) == null ? void 0 : y.map(C),
            };
      case "intersection":
        return {
          ...i,
          name: a,
          value: (m = n.elements) == null ? void 0 : m.map(C),
        };
      default:
        ...
        return (
          (p = n.elements) != null && p.every((E) => E.name === "literal")
            ? (h = {
                ...
                name: "enum",
                value:
                  (u = n.elements) == null ? void 0 : u.map((E) => Ce(E.value)),
              })
            : (h = {
                ...i,
                name: a,
...
function et({ fence: n = "```" } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let y of i)
      Ln.test(y.tokens.description) && !u
        ? p.push([y])
        : p[p.length - 1].push(y),
  ...
  return function (E) {
    ...
    for (let ae of He(E)) {
      ...
      N.push({
        ...
        tags: X,
        source: K,
        problems: X.reduce((P, oe) => P.concat(oe.problems), []),
      });
    }
    return N;
  };

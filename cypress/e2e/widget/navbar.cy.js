...
describe("Navbar.cy.ts", function () {
    ...
    it("Testing component Navbar", function () {
        ...
        cy.get("svg").eq(0).should("exist").and("have.class", consts_1.navbar_logoPicture);
        ...
        (0, cypressTests_1.buttonCypress)(0, rgdColors_1.primary_text_color_light, "0px");
        (0, cypressTests_1.clearButtonCypress)(0, rgdColors_1.primary_text_color_light);
        (0, cypressTests_1.sizeMButtonCypress)(0);
        cy.get("button").eq(0).should("exist").click();
        (0, cypressTests_1.buttonCypress)(1, rgdColors_1.primary_text_color_dark, "0px");
        (0, cypressTests_1.clearButtonCypress)(1, rgdColors_1.primary_text_color_dark);
        ...
        cy.get("button")
            ...
            .and("have.css", "height", "75px")
            .click();
        (0, cypressTests_1.buttonCypress)(2, rgdColors_1.primary_text_color_dark, "0px");
        (0, cypressTests_1.clearButtonCypress)(2, rgdColors_1.primary_text_color_dark);
        cy.get("button")
            .eq(2)
            .should("exist")
        ...
        (0, cypressTests_1.buttonCypress)(3, rgdColors_1.primary_text_color_dark, "0px");
        (0, cypressTests_1.clearButtonCypress)(3, rgdColors_1.primary_text_color_dark);

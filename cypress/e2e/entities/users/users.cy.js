...
describe("Users.cy.ts", function () {
    it("Testing component Users", function () {
        ...
        cy.get("div")
            .eq(16)
            .should("have.text", " Поиск>Leanne GrahamЧитать далееErvin HowellЧитать далееClementine BauchЧитать далееPatricia LebsackЧитать далееChelsey DietrichЧитать далееMrs. Dennis SchulistЧитать далееKurtis WeissnatЧитать далееNicholas Runolfsdottir VЧитать далееGlenna ReichertЧитать далееClementina DuBuqueЧитать далее");

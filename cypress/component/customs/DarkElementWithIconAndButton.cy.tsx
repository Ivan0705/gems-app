...
import { app, dark, outline, size_m } from "../../consts";
import {
  btn,
  icon,
  withIconWithButton,
...
describe("Testing custom element...", () => {
  it("Mounting component and testing...", () => {
        ...
        <div className={cls.withIconWithButton}>
          <div className={cls.withIconWithButton_wrapper}>
            <div className={cls.withIconWithButton_wapperTitleAndButton}>
              ...
              <div className={cls.withIconWithButton_title}>DIAMOND</div>
              <Button
    ...
    cy.get("div")
      ...
      .and("have.text", "DIAMOND");

    buttonCypress(0, "rgb(202, 200, 206)", "6px 15px");
    ...
    cy.get("button")
      ...
      .trigger("hover")
      .and("have.css", "color", "rgb(202, 200, 206)")
      .and(
        "have.css",
        "background",
      ...
      .and("have.css", "border", "1px solid rgb(202, 200, 206)")
      .and("have.css", "color", "rgb(202, 200, 206)")
      .and(
        "have.css",
        "background",
